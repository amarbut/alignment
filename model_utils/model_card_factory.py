...
def create_model_card(model_base) -> ModelCard:
    ...
    if 'UnslothOSSModel' in model_type or 'unsloth' in model_path:
        from model_utils.unsloth_oss_model_card import UnslothOSSModelCard
    ...
    # Standard OSS
        ...
        from model_utils.oss_model_card import OSSModelCard
    ...
    # === Mixtral Detection ===
        ...
        from model_utils.mixtral_model_card import MixtralModelCard
    ...
    # === DeepSeek Detection ===
        ...
        from model_utils.deepseek_model_card import DeepSeekModelCard
